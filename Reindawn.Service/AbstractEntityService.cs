...
{
    public abstract class AbstractEntityService<T> : IEntityService<T> where T : class, new()
    {
        #region Members
        ...
        //public void ToogleStatus(Guid[] ids)
        //{
        //    foreach (var domainModel in ids.Select(Find))
        //    {
        ...
        protected abstract Expression<Func<T, bool>> FindEntityPrimaryById(Guid id);
        ...
        //public virtual bool CanDeleteEntityById(Guid id)
        //{
        //    return true;
        //}
    }
